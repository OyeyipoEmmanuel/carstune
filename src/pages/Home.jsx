...
const Home = () => {
  ...
  return (
    <main className="w-full h-screen flex shrink-0 relative overflow-hidden bg-[#F8F9FA]">
      ...
      {/* {isLoading && <Loader />} */}
      {/* LEFT: 3D VIEWER (70%) */}
      <section className="flex-7 shrink-0 h-[85%] md:h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-neutral-700 relative rounded-b-4xl md:rounded-none overflow-hidden">
        {/* Title overlay */}
