...
Command: npx gltfjsx@6.5.3 public/model/carWithStickerModel.glb 
*/
...
export function CarWithStickerModel(props) {
  ...
  //     ? "/model/untitled.glb"
  //     : "/model/carWithStickerModel.glb";
  // });

  //  { position: [0.19, -0.1, 0.14], rotation: [0, 0, 0], isLeft: false },           // Front Right
  // { position: [0.19, -0.1, -1.15], rotation: [0, 0, 0], isLeft: false },          // Rear Right
  // { position: [-0.19, -0.12, 1.2], rotation: [Math.PI, 0, Math.PI], isLeft: true },  // Front Left
  // { position: [-0.19, -0.12, -0.08], rotation: [Math.PI,0,Math.PI], isLeft: true }  // Rear Left
    ...
    <group {...props} dispose={null}>
      ...
      >
        <meshStandardMaterial
          ...
          depthWrite={false} // ✅ must be false when transparent=true
          polygonOffset={true}
          polygonOffsetFactor={-4} // ✅ stronger offset to prevent z-fighting
